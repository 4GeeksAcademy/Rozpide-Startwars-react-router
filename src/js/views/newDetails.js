  ...
  useEffect(() => {
    ...
    const fetchValidImageUrl = async (initialUrl) => {
      ...
      while (!response.ok) {
        ...
        if (currentId > 1000) break; // Ajusta este límite según sea necesario
      }
    ...
    <div className="container mt-5">
      <div className="card w-100">
        <div className="card-body d-flex">
          ...
          <div className="details-container ms-3">
            <h1>{details.name || details.title}</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur scelerisque vehicula nulla, a fermentum magna vestibulum et. Nulla facilisi. Quisque bibendum semper risus, in scelerisque purus ullamcorper in. Sed at sem vehicula, scelerisque ex vel, consequat urna.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur scelerisque vehicula nulla, a fermentum magna vestibulum et. Nulla facilisi. Quisque bibendum semper risus, in scelerisque purus ullamcorper in. Sed at sem vehicula, scelerisque ex vel, consequat urna.</p>
          </div>
        </div>
        <div className="card-footer d-flex flex-wrap">
          {category === "people" && (
